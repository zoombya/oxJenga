...
import {makeTopFile, makeDatFile, updateStrandsFromDat, makeFileDropable} from './UTILS/file.js'
...
function onSelectStart(event) {
    ...
    if (intersections.length > 0) {
        ...
        console.log(`Pull particle ${intersection.instanceId} at ${nucPos.clone().multiplyScalar(50).toArray().map(v=>v.toFixed(3))} toward ${oxDNATarget.toArray()}`)
